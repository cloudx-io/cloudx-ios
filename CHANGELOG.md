...
- **Certified with UnityAds 4.20.1** — Updates UnityAds from 4.20.0 to 4.20.1. `CloudXCore >= 3.5.0` and iOS 13.0 requirements are unchanged.
...
- **Certified with Google Mobile Ads SDK 13.9.0** — Updates Google Mobile Ads SDK from 13.8.0 to 13.9.0. `CloudXCore >= 3.7.0` and iOS 13.0 requirements are unchanged.

---

## Google Waterfall adapter 13.8.0.0 - 2026-09-14

Install: `pod 'CloudXGoogleWaterfallAdapter', '~> 13.8.0.0'`

### Changed

- **Certified with Google Mobile Ads SDK 13.8.0** — Updates Google Mobile Ads SDK from 13.7.0 to 13.8.0. `CloudXCore >= 3.7.0` and iOS 13.0 requirements are unchanged.
...
- **Certified with Moloco SDK 4.10.0** — Updates MolocoSDKiOS from 4.9.1 to 4.10.0. No integration change is required; `CloudXCore >= 3.5.0` and iOS 13.0 requirements are unchanged.
...
- **Certified with Moloco SDK 4.9.0** — Updates MolocoSDKiOS from 4.8.1 to 4.9.0. No integration change is required; `CloudXCore >= 3.5.0` and iOS 13.0 requirements are unchanged.

---

## Moloco adapter 4.8.1.0 - 2026-09-14

Install: `pod 'CloudXMolocoAdapter', '~> 4.8.1.0'`

### Changed

- **Certified with Moloco SDK 4.8.1** — Updates MolocoSDKiOS from 4.8.0 to 4.8.1. No integration change is required; `CloudXCore >= 3.5.0` and iOS 13.0 requirements are unchanged.

---

## Pangle adapter 8.3.0.6.0 - 2026-09-14

Install: `pod 'CloudXPangleAdapter', '~> 8.3.0.6.0'`

### Changed

- **Certified with Pangle SDK 8.3.0.6** — Updates Ads-Global from 8.2.1.0 to 8.3.0.6. No integration change is required; `CloudXCore >= 3.5.0` and iOS 13.0 requirements are unchanged.

---

## Pangle adapter 8.2.1.0.0 - 2026-09-14

Install: `pod 'CloudXPangleAdapter', '~> 8.2.1.0.0'`

### Changed

- **Certified with Pangle SDK 8.2.1.0** — Updates Ads-Global from 8.2.0.9 to 8.2.1.0. No integration change is required; `CloudXCore >= 3.5.0` and iOS 13.0 requirements are unchanged.

---

## Pangle adapter 8.2.0.9.0 - 2026-09-14

Install: `pod 'CloudXPangleAdapter', '~> 8.2.0.9.0'`

### Changed

- **Certified with Pangle SDK 8.2.0.9** — Updates Ads-Global from 8.2.0.8 to 8.2.0.9. No integration change is required; `CloudXCore >= 3.5.0` and iOS 13.0 requirements are unchanged.
...
- **Certified with Pangle SDK 8.2.0.8** — Updates Ads-Global from 8.2.0.7 to 8.2.0.8. No integration change is required; `CloudXCore >= 3.5.0` and iOS 13.0 requirements are unchanged.
...
Compatibility-line release for apps pinned to Pangle Ads-Global 8.1.0.6. New integrations should use the 8.2.0.7.x line.

### Added
- **Compatibility-line release for Pangle Ads-Global 8.1.0.6** — The 8.2.0.7.0 adapter rebuilt against Ads-Global 8.1.0.6; same feature set, no source change. Requires `CloudXCore >= 3.5.0`.
