...
#import <CloudXCore/CloudXCoreError.h>

@class CLXBiddingConfigResponseBid, CLXBiddingConfigRequest;
...
@property (nonatomic, strong, readonly) CLXBiddingConfigResponseBid *bid;
                   ...
                   auctionId:(nullable NSString *)auctionId
                     ...
                     latency:(double)latency
                        ...
                        bidID:(NSString *)bidID
                          bid:(CLXBiddingConfigResponseBid *)bid
