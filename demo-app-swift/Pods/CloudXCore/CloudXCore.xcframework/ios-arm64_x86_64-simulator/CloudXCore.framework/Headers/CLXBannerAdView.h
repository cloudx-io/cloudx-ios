...
/**
 * CloudXBannerAdView represents a banner ad view in the CloudX SDK.
 */
@interface CLXBannerAdView : UIView <CLXAd, CLXBannerDelegate, CLXBaseAdDelegate>

/**
 * A weak reference to the object that implements CloudXBannerDelegate protocol. 
...
/**
 * Initializes a new CloudXBannerAdView with the given banner, type, and delegate.
