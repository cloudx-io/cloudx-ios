...
@class CLXBiddingConfigResponse;
@class CLXBiddingConfigResponseSeatbid;
@class CLXBiddingConfigResponseBid;
@class CLXBiddingConfigResponseExt;

// Forward declarations for nested response types (add at the top if not present)
@class CLXBiddingConfigResponseBidExt;
@class CLXBiddingConfigResponseBidExtSKAd;
@class CLXBiddingConfigResponseBidExtCloudX;
@class CLXBiddingConfigResponseBidExtCloudXMeta;
@class CLXBiddingConfigResponseBidExtSKAdFidelity;
@class CLXBiddingConfigResponseExt;
...
// MARK: - Response
@interface CLXBiddingConfigResponse : NSObject
@property (nonatomic, copy, nullable) NSString *id;
@property (nonatomic, copy, nullable) NSString *bidid;
@property (nonatomic, strong) NSArray<CLXBiddingConfigResponseSeatbid *> *seatbid;
@property (nonatomic, copy, nullable) NSString *cur;
@property (nonatomic, strong, nullable) CLXBiddingConfigResponseExt *ext;
@end

@interface CLXBiddingConfigResponseSeatbid : NSObject
@property (nonatomic, strong) NSArray<CLXBiddingConfigResponseBid *> *bid;
@property (nonatomic, copy, nullable) NSString *seat;
@end

@interface CLXBiddingConfigResponseBid : NSObject
@property (nonatomic, copy, nullable) NSString *id;
...
@property (nonatomic, strong, nullable) CLXBiddingConfigResponseBidExt *ext;
@end

@interface CLXBiddingConfigResponseBidExt : NSObject
@property (nonatomic, strong, nullable) CLXBiddingConfigResponseBidExtSKAd *skadn;
@property (nonatomic, assign) double origbidcpm;
@property (nonatomic, copy, nullable) NSString *origbidcur;
@property (nonatomic, strong, nullable) CLXBiddingConfigResponseBidExtCloudX *cloudx;
@end

@interface CLXBiddingConfigResponseBidExtCloudX : NSObject
@property (nonatomic, strong, nullable) CLXBiddingConfigResponseBidExtCloudXMeta *meta;
@property (nonatomic, assign) NSInteger rank;
@property (nonatomic, strong, nullable) NSDictionary<NSString *, NSString *> *adapterExtras;
@end

@interface CLXBiddingConfigResponseBidExtCloudXMeta : NSObject
@property (nonatomic, copy) NSString *adaptercode;
@end

@interface CLXBiddingConfigResponseBidExtSKAd : NSObject
...
@property (nonatomic, strong) NSArray<CLXBiddingConfigResponseBidExtSKAdFidelity *> *fidelities;
...
@interface CLXBiddingConfigResponseBidExtSKAdFidelity : NSObject
...
@interface CLXBiddingConfigResponseExt : NSObject
// Add response ext properties as needed
@end
