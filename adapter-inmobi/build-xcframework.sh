...
bash ../scripts/validate-compile-sources.sh Sources/CloudXInMobiAdapter CloudXInMobiAdapter.xcodeproj/project.pbxproj || print_error "Compile sources validation failed. See above."
...
xcodebuild archive \
  ...
  HEADER_SEARCH_PATHS='$(SRCROOT)/Sources/CloudXInMobiAdapter $(SRCROOT)/Sources/CloudXInMobiAdapter/Base $(SRCROOT)/Sources/CloudXInMobiAdapter/Banner $(SRCROOT)/Sources/CloudXInMobiAdapter/BidTokenSource $(SRCROOT)/Sources/CloudXInMobiAdapter/Initializers $(SRCROOT)/Sources/CloudXInMobiAdapter/Interstitial $(SRCROOT)/Sources/CloudXInMobiAdapter/Rewarded $(SRCROOT)/Sources/CloudXInMobiAdapter/Utils' \
  USER_HEADER_SEARCH_PATHS='$(SRCROOT)/Sources/CloudXInMobiAdapter $(SRCROOT)/Sources/CloudXInMobiAdapter/Base $(SRCROOT)/Sources/CloudXInMobiAdapter/Banner $(SRCROOT)/Sources/CloudXInMobiAdapter/BidTokenSource $(SRCROOT)/Sources/CloudXInMobiAdapter/Initializers $(SRCROOT)/Sources/CloudXInMobiAdapter/Interstitial $(SRCROOT)/Sources/CloudXInMobiAdapter/Rewarded $(SRCROOT)/Sources/CloudXInMobiAdapter/Utils' \
