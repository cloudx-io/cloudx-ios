...
xcodebuild archive \
  ...
  HEADER_SEARCH_PATHS='$(SRCROOT)/Sources/CloudXInMobiAdapter $(SRCROOT)/Sources/CloudXInMobiAdapter/Base $(SRCROOT)/Sources/CloudXInMobiAdapter/Banner $(SRCROOT)/Sources/CloudXInMobiAdapter/BidTokenSource $(SRCROOT)/Sources/CloudXInMobiAdapter/Initializers $(SRCROOT)/Sources/CloudXInMobiAdapter/Interstitial $(SRCROOT)/Sources/CloudXInMobiAdapter/Native $(SRCROOT)/Sources/CloudXInMobiAdapter/Rewarded $(SRCROOT)/Sources/CloudXInMobiAdapter/Utils' \
  USER_HEADER_SEARCH_PATHS='$(SRCROOT)/Sources/CloudXInMobiAdapter $(SRCROOT)/Sources/CloudXInMobiAdapter/Base $(SRCROOT)/Sources/CloudXInMobiAdapter/Banner $(SRCROOT)/Sources/CloudXInMobiAdapter/BidTokenSource $(SRCROOT)/Sources/CloudXInMobiAdapter/Initializers $(SRCROOT)/Sources/CloudXInMobiAdapter/Interstitial $(SRCROOT)/Sources/CloudXInMobiAdapter/Native $(SRCROOT)/Sources/CloudXInMobiAdapter/Rewarded $(SRCROOT)/Sources/CloudXInMobiAdapter/Utils' \
