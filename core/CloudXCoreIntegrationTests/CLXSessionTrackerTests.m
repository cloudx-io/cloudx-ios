 ...
 * dispatches to a background queue, and the original tests used
 * dispatch_after with hardcoded delays to race against it. Under
 * parallel test execution this causes flaky timeouts.
 *
 * Deterministic unit tests for payload construction live in
 * CloudXCoreTests/CLXSessionTrackerTests.m.
 */
