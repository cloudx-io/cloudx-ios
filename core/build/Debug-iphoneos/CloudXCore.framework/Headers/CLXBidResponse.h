...
// Helper method to get all bids from all seatbids
- (NSArray<CLXBidResponseBid *> *)allBids;

// REMOVED: getNextWinBid and getNextWinBidAndFireLossNotifications
// These methods pre-selected winners without trying to load (not true waterfall)
// Use getAllBidsForWaterfall instead for proper Android parity
