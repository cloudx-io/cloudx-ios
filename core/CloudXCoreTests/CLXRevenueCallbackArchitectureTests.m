...
- (void)testCLXAdFactoryMethodWithValidData {
    ...
    CLXAd *ad = [CLXAd adFromBid:mockBid adUnitId:@"test-placement" adFormat:CLXAdFormatInterstitial placement:nil];
...
- (void)testCLXAdFactoryMethodWithCloudXFallback {
    ...
    CLXAd *ad = [CLXAd adFromBid:mockBid adUnitId:@"fallback-placement" adFormat:CLXAdFormatInterstitial placement:nil];
...
- (void)testCLXAdFactoryMethodPrioritizesPrebid {
    ...
    CLXAd *ad = [CLXAd adFromBid:mockBid adUnitId:@"priority-test" adFormat:CLXAdFormatInterstitial placement:nil];
...
- (void)testCLXAdFactoryMethodWithNilBid {
    CLXAd *ad = [CLXAd adFromBid:nil adUnitId:@"test-placement" adFormat:CLXAdFormatInterstitial placement:nil];
...
- (void)testCLXAdFactoryMethodWithNoBidderInfo {
    ...
    CLXAd *ad = [CLXAd adFromBid:mockBid adUnitId:@"no-bidder-test" adFormat:CLXAdFormatInterstitial placement:nil];
