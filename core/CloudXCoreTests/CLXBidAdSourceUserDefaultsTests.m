...
- (void)testBidAdSourceUpdatesMetricsDict {
    ...
    NSDictionary *existingMetrics = [self.testDefaults dictionaryForKey:kCLXCoreMetricsDictKey];
...
- (void)testBidAdSourceCollisionRisk {
    ...
    [self.testDefaults setObject:@{@"external": @"data"} forKey:kCLXCoreMetricsDictKey];
    [self.testDefaults synchronize];
    
    // Verify external data is stored
    NSDictionary *externalData = [self.testDefaults dictionaryForKey:kCLXCoreMetricsDictKey];
    ...
    [self.testDefaults setObject:@{@"cloudx_bid": @"metrics"} forKey:kCLXCoreMetricsDictKey];
    
    // External data is now lost - COLLISION!
    NSDictionary *finalData = [self.testDefaults dictionaryForKey:kCLXCoreMetricsDictKey];
