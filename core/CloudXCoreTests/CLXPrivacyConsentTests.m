...
@interface CLXPrivacyConsentTests : XCTestCase
@end

@implementation CLXPrivacyConsentTests
...
- (void)testConsentInitialization {
    ...
    CLXPrivacyConsent *defaultConsent = [[CLXPrivacyConsent alloc] init];
...
- (void)testConsentEqualityAndHashing {
    CLXPrivacyConsent *consent1 = [[CLXPrivacyConsent alloc] initWithSaleOptOut:@1 sharingOptOut:@2];
    CLXPrivacyConsent *consent2 = [[CLXPrivacyConsent alloc] initWithSaleOptOut:@1 sharingOptOut:@2];
    CLXPrivacyConsent *consent3 = [[CLXPrivacyConsent alloc] initWithSaleOptOut:@2 sharingOptOut:@1];
...
- (void)testConsentDescription {
    CLXPrivacyConsent *consent = [[CLXPrivacyConsent alloc] initWithSaleOptOut:@1 sharingOptOut:@0];
    NSString *description = [consent description];
    
    XCTAssertTrue([description containsString:@"CLXPrivacyConsent"], @"Description should contain class name");
...
- (void)testPiiRemovalEdgeCases {
    ...
    CLXPrivacyConsent *highValue = [[CLXPrivacyConsent alloc] initWithSaleOptOut:@99 sharingOptOut:@0];
    XCTAssertFalse([highValue requiresPiiRemoval], @"High numeric values should not trigger PII removal");
    
    // Test with negative values
    CLXPrivacyConsent *negativeValue = [[CLXPrivacyConsent alloc] initWithSaleOptOut:@(-1) sharingOptOut:@0];
    ...
    CLXPrivacyConsent *mixedNil1 = [[CLXPrivacyConsent alloc] initWithSaleOptOut:@1 sharingOptOut:nil];
    XCTAssertTrue([mixedNil1 requiresPiiRemoval], @"Sale opt-out with nil sharing should require PII removal");
    
    CLXPrivacyConsent *mixedNil2 = [[CLXPrivacyConsent alloc] initWithSaleOptOut:nil sharingOptOut:@1];
