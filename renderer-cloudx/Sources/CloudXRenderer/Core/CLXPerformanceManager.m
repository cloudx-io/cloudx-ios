...
//  CloudXRenderer
//
//  Performance optimization implementation for CloudX Renderer
//  
...
- (instancetype)init {
    ...
    if (self) {
        ...
        _backgroundQueue = dispatch_queue_create("com.cloudx.renderer.background", DISPATCH_QUEUE_CONCURRENT);
        _cacheQueue = dispatch_queue_create("com.cloudx.renderer.cache", DISPATCH_QUEUE_SERIAL);
