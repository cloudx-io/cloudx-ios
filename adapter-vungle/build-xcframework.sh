...
xcodebuild archive \
  ...
  HEADER_SEARCH_PATHS='$(SRCROOT)/Sources/CloudXVungleAdapter $(SRCROOT)/Sources/CloudXVungleAdapter/Base $(SRCROOT)/Sources/CloudXVungleAdapter/Banner $(SRCROOT)/Sources/CloudXVungleAdapter/Initializers $(SRCROOT)/Sources/CloudXVungleAdapter/Interstitial $(SRCROOT)/Sources/CloudXVungleAdapter/Native $(SRCROOT)/Sources/CloudXVungleAdapter/Rewarded $(SRCROOT)/Sources/CloudXVungleAdapter/AppOpen $(SRCROOT)/Sources/CloudXVungleAdapter/BidTokenSource $(SRCROOT)/Sources/CloudXVungleAdapter/Utils' \
  USER_HEADER_SEARCH_PATHS='$(SRCROOT)/Sources/CloudXVungleAdapter $(SRCROOT)/Sources/CloudXVungleAdapter/Base $(SRCROOT)/Sources/CloudXVungleAdapter/Banner $(SRCROOT)/Sources/CloudXVungleAdapter/Initializers $(SRCROOT)/Sources/CloudXVungleAdapter/Interstitial $(SRCROOT)/Sources/CloudXVungleAdapter/Native $(SRCROOT)/Sources/CloudXVungleAdapter/Rewarded $(SRCROOT)/Sources/CloudXVungleAdapter/AppOpen $(SRCROOT)/Sources/CloudXVungleAdapter/BidTokenSource $(SRCROOT)/Sources/CloudXVungleAdapter/Utils' \
