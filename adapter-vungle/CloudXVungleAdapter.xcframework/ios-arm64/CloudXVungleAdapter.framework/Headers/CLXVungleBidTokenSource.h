...
/**
 * Vungle bid token source for CloudX bidding integration.
 * 
 * The bid token is a cryptographically signed payload generated by Vungle's SDK that contains:
 ...
 * 
 * This token is generated fresh for each auction request and allows Vungle to:
 ...
 * 
 * The token is passed to CloudX's auction server, which forwards it to Vungle's
 * bidding endpoint during the OpenRTB auction process. Vungle uses this token
...
/**
 * Shared instance for Vungle bid token source.
 ...
 * @return New instance of Vungle bid token source
 */
