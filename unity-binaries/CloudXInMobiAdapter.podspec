...
#
# Based on: cloudx-ios/adapter-inmobi/CloudXInMobiAdapter.podspec (public binary distribution)

Pod::Spec.new do |s|
  s.name             = 'CloudXInMobiAdapter'
  s.version          = '2.0.0-rc.47+89a05d4'
  s.summary          = 'CloudX InMobi Adapter - Static Framework'
  s.description      = 'InMobi adapter for CloudX iOS SDK - RC binary distribution'
