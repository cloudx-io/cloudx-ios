Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'https://github.com/cloudx-io/cloudx-ios.git', :tag => "adapter-googlewaterfall/#{s.version}" }

  s.ios.deployment_target = '13.0'
  s.vendored_frameworks = 'adapter-googlewaterfall/CloudXGoogleWaterfallAdapter.xcframework'

  s.dependency 'CloudXCore', '>= 3.4.6', '< 3.5'
