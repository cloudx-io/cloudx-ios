...
bash ../scripts/validate-compile-sources.sh Sources/CloudXMintegralAdapter CloudXMintegralAdapter.xcodeproj/project.pbxproj || print_error "Compile sources validation failed. See above."
