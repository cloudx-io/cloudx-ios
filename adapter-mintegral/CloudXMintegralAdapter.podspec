Pod::Spec.new do |s|
  ...
  s.dependency 'MintegralAdSDK/BidBannerAd', '= 8.0.9'
  s.dependency 'MintegralAdSDK/BidNewInterstitialAd', '= 8.0.9'
  s.dependency 'MintegralAdSDK/BidRewardVideoAd', '= 8.0.9'
  s.dependency 'MintegralAdSDK/BidNativeAdvancedAd', '= 8.0.9'
