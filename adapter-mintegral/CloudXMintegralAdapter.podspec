Pod::Spec.new do |s|
  ...
  s.dependency 'MintegralAdSDK/BidBannerAd', '= 8.1.6'
  s.dependency 'MintegralAdSDK/BidNewInterstitialAd', '= 8.1.6'
  s.dependency 'MintegralAdSDK/BidRewardVideoAd', '= 8.1.6'
  s.dependency 'MintegralAdSDK/BidNativeAdvancedAd', '= 8.1.6'
